...
# Input files
TPR_FILE = "M3.tpr"
XTC_FILE = "molcenterclusterM3.xtc"

# Output folder in the current working directory
OUT_DIR = "10chainsRgM3"
...
RIGHT_Y_LABEL = "Largest cluster size\n($N_{\\mathrm{chain}}$)"
# 两张图各自使用的左 y 轴标题
...
TRAJECTORY_TIME_TO_NS_FACTOR = 0.001
